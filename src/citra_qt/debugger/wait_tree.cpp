...
std::vector<std::unique_ptr<WaitTreeItem>> WaitTreeThread::GetChildren() const {
    ...
    list.push_back(std::make_unique<WaitTreeText>(tr("processor = %1")
        .arg(processor)));
...
std::vector<std::unique_ptr<WaitTreeItem>> WaitTreeEvent::GetChildren() const {
    ...
    list.push_back(std::make_unique<WaitTreeText>(tr("reset type = %1")
...
std::vector<std::unique_ptr<WaitTreeItem>> WaitTreeTimer::GetChildren() const {
    ...
    list.push_back(std::make_unique<WaitTreeText>(tr("reset type = %1")
        .arg(GetResetTypeQString(timer.reset_type))));
    list.push_back(std::make_unique<WaitTreeText>(tr("initial delay = %1")
        .arg(timer.initial_delay)));
    list.push_back(std::make_unique<WaitTreeText>(tr("interval delay = %1")
